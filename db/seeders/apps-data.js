    ...
    return queryInterface.bulkInsert('apps', [
      {
        ...
        owner: 'test.ezira',
        redirect_uris: JSON.stringify(['http://localhost:5555/demo', 'http://localhost:5555', 'https://auth.ezira.io/demo', 'https://ezira.io/callback']),
        name: 'Ezira.io',
        description: 'Ensuring non-brutal life',
        icon: 'https://byteball.co/img/logo.jpg',
        website: 'https://ezira.io',
        beneficiaries: JSON.stringify([{ account: 'test.ezira.auth', weight: 1500 }]),
        is_approved: true,
        is_public: true,
        is_disabled: false,
